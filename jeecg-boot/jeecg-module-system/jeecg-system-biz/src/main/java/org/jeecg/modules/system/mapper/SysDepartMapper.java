...
public interface SysDepartMapper extends BaseMapper<SysDepart> {
	 ...
	 * @return
	 */
	List<SysDepart> getDepartByName(@Param("departName") String departName, @Param("tenantId") Integer tenantId,
	 ...
	 * @return
	 */
	List<SysUserDepVo> getUserDepartByTenantUserId(@Param("userList") List<SysUser> userList,
	 ...
	 * @return
	 */
	List<SysDepart> getDepartPageByName(@Param("page") Page<SysDepart> page, @Param("departName") String departName,
