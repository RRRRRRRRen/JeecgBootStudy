...
public class ImportExcelUtil {
     ...
     * @throws IOException
     */
    public static Result<?> imporReturnRes(
            int errorLines,
            int successLines,
     ...
     * @return
     */
    public static <T, S extends IService<T>> List<String> importDateSave(
            List<T> list,
            Class<S> serviceClass,
            List<String> errorMessage,
            String errorFlag) {
        S bean = SpringContextUtils.getBean(serviceClass);
     ...
     * @return
     */
    public static <T, S extends IService<T>> List<String> importDateSaveOne(
            T obj,
            Class<S> serviceClass,
            List<String> errorMessage,
            int i,
